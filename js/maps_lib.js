...
var MapsLib = {
  ...
  fusionTableId:      "1ht_dGlQWrZQ6-6KPCEOTqB_2GPYEDtwz35xTA-QC",
  ...
  locationColumn:     "'Study Location'",

  map_centroid:       new google.maps.LatLng(35.524516, 21.145203), //MODIFY center that your map defaults to
  locationScope:      "earth",      //MODIFY geographical area appended to all address searches
  ...
  //-----custom filters-------
    ...
    var type_column = "'Commodity focus'";  // -- note use of single & double quotes for two-word column header
    var tempWhereClause = [];
    if ( $("#cbType1").is(':checked')) tempWhereClause.push("Agriculture");
    if ( $("#cbType2").is(':checked')) tempWhereClause.push("Forestry");
    if ( $("#cbType3").is(':checked')) tempWhereClause.push("Aquaculture");
